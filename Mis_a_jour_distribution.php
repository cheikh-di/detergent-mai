...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE distribition SET Num_prod=%s, Quantite=%s, Date_livraison=%s, Numéro_lot=%s WHERE Num_clt=%s",
                       GetSQLValueString($_POST['Num_prod'], "text"),
                       GetSQLValueString($_POST['Quantite'], "int"),
                       GetSQLValueString($_POST['Date_livraison'], "date"),
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<td height="70" colspan="2" class="logo" nowrap="nowrap">MIS_A_JOUR_DISTRIBUTION</td>
	<td width="100%">&nbsp;</td>
	</tr>
	...
	<td width="710" valign="top"><form method="post" name="form1" action="<?php echo $editFormAction; ?>">
      <table align="center">
        ...
        <tr valign="baseline">
          <td nowrap align="right">Date_livraison:</td>
          <td><input type="text" name="Date_livraison" value="<?php echo $row_Recordset1['Date_livraison']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
