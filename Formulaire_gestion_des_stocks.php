...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO gestion_des_stocks (Num_prod, Num_frs, Code_référence, Nom_prod, Date_entrée, Quantité, Numéro_lot, Date_expiration) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<td height="70" colspan="2" class="logo" nowrap="nowrap">FORMULAIRE_GESTION_DES_STOCKS </td>
	<td width="100%">&nbsp;</td>
	</tr>
	...
	<td width="710" valign="top"><form method="post" name="form1" action="<?php echo $editFormAction; ?>">
      <table align="center">
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="Num_frs" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Code_référence:</td>
          <td><input type="text" name="Code_rfrence" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Nom_prod:</td>
          <td><input type="text" name="Nom_prod" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Date_entrée:</td>
          <td><input type="text" name="Date_entre" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="Numro_lot" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
