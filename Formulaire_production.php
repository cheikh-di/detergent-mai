...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO production (Code_référence, Nom_prod, Quantite, Date_fabrication, Numéro_lot) VALUES (%s, %s, %s, %s, %s)",
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<td height="70" colspan="2" class="logo" nowrap="nowrap">FORMULAIRE_PRODUCTION</td>
	<td width="100%">&nbsp;</td>
	</tr>
	...
	<td width="710" valign="top"><form method="post" name="form1" action="<?php echo $editFormAction; ?>">
      <table align="center">
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="Date_fabrication" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
