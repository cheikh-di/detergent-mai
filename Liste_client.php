...
mysql_select_db($database_H_D_Industrie, $H_D_Industrie);
$query_Recordset2 = "SELECT * FROM client";
$Recordset2 = mysql_query($query_Recordset2, $H_D_Industrie) or die(mysql_error());
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<td height="70" colspan="2" class="logo" nowrap="nowrap">LISTE_CLIENT</td>
	<td width="100%">&nbsp;</td>
	</tr>
