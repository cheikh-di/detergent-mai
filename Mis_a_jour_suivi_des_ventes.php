...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE suivi_des_ventes SET Num_clt=%s, Date_vente=%s, Quantité=%s, Prix=%s, point_de_vente=%s, Mode_paiement=%s WHERE Num_prod=%s",
                       ...
                       GetSQLValueString($_POST['point_de_vente'], "text"),
                       GetSQLValueString($_POST['Mode_paiement'], "text"),
...
$queryString_Recordset1 = sprintf("&totalRows_Recordset1=%d%s", $totalRows_Recordset1, $queryString_Recordset1);?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<td height="70" colspan="2" class="logo" nowrap="nowrap">MIS_A_JOUR_SUIVI_DES_VENTES</td>
	<td width="100%">&nbsp;</td>
	</tr>
	...
	<td width="710" valign="top"><form method="post" name="form1" action="<?php echo $editFormAction; ?>">
      <table align="center">
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="Num_clt" value="<?php echo $row_Recordset1['Num_clt']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Date_vente:</td>
          <td><input type="text" name="Date_vente" value="<?php echo $row_Recordset1['Date_vente']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          <td nowrap align="right">Point_de_vente:</td>
          <td><input type="text" name="point_de_vente" value="<?php echo $row_Recordset1['point_de_vente']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Mode_paiement:</td>
          <td><input type="text" name="Mode_paiement" value="<?php echo $row_Recordset1['Mode_paiement']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
