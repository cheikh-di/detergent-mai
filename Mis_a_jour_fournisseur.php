...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE fournisseur SET Nom=%s, Prénom=%s, Adresse=%s, Num_tel=%s WHERE Num_frs=%s",
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<td height="70" colspan="2" class="logo" nowrap="nowrap">MIS_A_JOUR_FOURNISSEUR</td>
	<td width="100%">&nbsp;</td>
	</tr>
	...
	<td width="710" valign="top"><form method="post" name="form1" action="<?php echo $editFormAction; ?>">
      <table align="center">
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="Prnom" value="<?php echo $row_Recordset1['Prénom']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="Num_tel" value="<?php echo $row_Recordset1['Num_tel']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
      ...
      <input type="hidden" name="Num_frs" value="<?php echo $row_Recordset1['Num_frs']; ?>">
    </form>
	  <p>&nbsp;</p>
	  <br />
	&nbsp;<br />
