...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE client SET Nom=%s, Prénom=%s, Adresse=%s, Num_tel=%s WHERE Num_clt=%s",
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<td height="70" colspan="2" class="logo" nowrap="nowrap">MIS_A_JOUR_CLIENT</td>
	<td width="100%">&nbsp;</td>
	</tr>
