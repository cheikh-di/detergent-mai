...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO produit (Num_prod, Nom_prod, Poids, Date_fabrication, Date_expiration) VALUES (%s, %s, %s, %s, %s)",
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<td height="70" colspan="2" class="logo" nowrap="nowrap">FORMULAIRE_PRODUIT</td>
	<td width="100%">&nbsp;</td>
	</tr>
