...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE produit SET Nom_prod=%s, Poids=%s, Date_fabrication=%s, Date_expiration=%s WHERE Num_prod=%s",
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<td height="70" colspan="2" class="logo" nowrap="nowrap">MIS_A_JOUR_PRODUIT</td>
	<td width="100%">&nbsp;</td>
	</tr>
	...
	<table border="0" cellpadding="0" cellspacing="0" id="navigation">
      ...
      </table><a href="index.php"><span class="Style3">Accueil</span>	
    <?php do { ?>
