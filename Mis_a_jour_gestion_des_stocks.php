...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE gestion_des_stocks SET Num_frs=%s, Code_référence=%s, Nom_prod=%s, Date_entrée=%s, Quantité=%s, Numéro_lot=%s, Date_expiration=%s WHERE Num_prod=%s",
                       GetSQLValueString($_POST['Num_frs'], "text"),
                       GetSQLValueString($_POST['Code_rfrence'], "text"),
                       GetSQLValueString($_POST['Nom_prod'], "text"),
                       GetSQLValueString($_POST['Date_entre'], "date"),
                       GetSQLValueString($_POST['Quantit'], "int"),
                       GetSQLValueString($_POST['Numro_lot'], "int"),
                       GetSQLValueString($_POST['Date_expiration'], "date"),
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<td height="70" colspan="2" class="logo" nowrap="nowrap">MIS_A_JOUR_GESTION_DES_STOCKS</td>
	<td width="100%">&nbsp;</td>
	</tr>
	...
	<td width="710" valign="top"><form method="post" name="form1" action="<?php echo $editFormAction; ?>">
      <table align="center">
        ...
        <tr valign="baseline">
          <td nowrap align="right">Num_frs:</td>
          <td><input type="text" name="Num_frs" value="<?php echo $row_Recordset1['Num_frs']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Code_référence:</td>
          <td><input type="text" name="Code_rfrence" value="<?php echo $row_Recordset1['Code_référence']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Nom_prod:</td>
          <td><input type="text" name="Nom_prod" value="<?php echo $row_Recordset1['Nom_prod']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Date_entrée:</td>
          <td><input type="text" name="Date_entre" value="<?php echo $row_Recordset1['Date_entrée']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          <td nowrap align="right">Numéro_lot:</td>
          <td><input type="text" name="Numro_lot" value="<?php echo $row_Recordset1['Numéro_lot']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Date_expiration:</td>
          <td><input type="text" name="Date_expiration" value="<?php echo $row_Recordset1['Date_expiration']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
      ...
      <input type="hidden" name="Num_prod" value="<?php echo $row_Recordset1['Num_prod']; ?>">
    </form>
	  <p>&nbsp;</p>
	  <br />
	&nbsp;<br />
