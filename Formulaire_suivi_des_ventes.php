...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO suivi_des_ventes (Num_prod, Num_clt, Date_vente, Quantité, Prix, point_de_vente, Mode_paiement) VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<td height="70" colspan="2" class="logo" nowrap="nowrap">FORMULAIRE_SUIVI_DES_VENTES</td>
	<td width="100%">&nbsp;</td>
	</tr>
	...
	<td width="710" valign="top"><form method="post" name="form1" action="<?php echo $editFormAction; ?>">
      <table align="center">
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="Date_vente" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td><input type="text" name="point_de_vente" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">Mode_paiement:</td>
          <td><input type="text" name="Mode_paiement" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
