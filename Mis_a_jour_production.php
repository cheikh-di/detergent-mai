...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE production SET Nom_prod=%s, Quantite=%s, Date_fabrication=%s, Numéro_lot=%s WHERE Code_référence=%s",
                       GetSQLValueString($_POST['Nom_prod'], "text"),
                       GetSQLValueString($_POST['Quantite'], "int"),
                       GetSQLValueString($_POST['Date_fabrication'], "date"),
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<td height="70" colspan="2" class="logo" nowrap="nowrap">MIS_A_JOUR_PRODUCTION</td>
	<td width="100%">&nbsp;</td>
	</tr>
	...
	<td width="710" valign="top"><form method="post" name="form1" action="<?php echo $editFormAction; ?>">
      <table align="center">
        ...
        <tr valign="baseline">
          <td nowrap align="right">Date_fabrication:</td>
          <td><input type="text" name="Date_fabrication" value="<?php echo $row_Recordset1['Date_fabrication']; ?>" size="32"></td>
        </tr>
        <tr valign="baseline">
      ...
      <input type="hidden" name="Code_référence" value="<?php echo $row_Recordset1['Code_référence']; ?>">
    </form>
	  <p>&nbsp;</p>
	  <br />
	&nbsp;<br />
